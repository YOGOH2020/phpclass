            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <form action="studentDelete.php" method="post">
                        ...
                        <input type="text" name="lName" class="form-control" required value="<?php print $row['last_name'];?>">
                        <label for=""><b>Course Code</b></label>
                        <input type="text" name="cCode" class="form-control" value="<?php print $row['course_code'];?>">
                        <hr>
                        <div class="buttons">
