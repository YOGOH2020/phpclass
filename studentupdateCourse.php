...
<div class="container" id="update">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            $sql = "update students set surname = '$surname',first_name = '$firstName',
last_name= '$lastName' where course_code = '$courseCode'";
            if ($conn -> query($sql) == true){
                print "<p>Student details updated Successfully</p>";
                print "<a href='students.php' class='btn btn-outline-success'>Update another Student</a>";
            }
            else{
                print "<p>Student details not updated</p>";
